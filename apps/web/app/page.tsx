  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f9faf8] text-[#191c1b]">
      ...
      <section className="relative min-h-[92svh] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_22%_26%,rgba(208,233,212,0.16),transparent_30%),linear-gradient(180deg,rgba(47,93,59,0.72),rgba(47,93,59,0.42)_42%,rgba(249,250,248,0.96)_96%)]" />
        <div className="absolute inset-x-0 top-0 h-36 bg-[linear-gradient(180deg,rgba(47,93,59,0.72),transparent)]" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[92svh] w-full max-w-7xl flex-col justify-center px-5 pb-24 pt-14 md:px-8">
          <div className="peak-stagger max-w-3xl">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Button size="lg" asChild className="peak-button-motion h-12 bg-white px-6 text-[#2f5d3b] hover:bg-[#d0e9d4]">
                <Link href="/signup">
                  Start building
                  <ArrowRightIcon />
                </Link>
          ...
          <div className="grid gap-3">
            {workflow.map((step, index) => (
              <div key={step} className="peak-lift flex items-center gap-3 rounded-lg border border-[#c3c8c1]/70 bg-white/70 p-3">
                <span className="grid size-8 place-items-center rounded-md bg-[#2f5d3b] text-sm font-semibold text-white">
                  {index + 1}
                </span>
      ...
      <section className="peak-reveal mx-auto grid w-full max-w-7xl gap-8 px-5 py-20 md:px-8 lg:grid-cols-[1fr_auto] lg:items-center">
        <div className="grid gap-4">
          <Badge className="w-fit bg-[#2f5d3b] text-white">Demo-ready SaaS</Badge>
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
          <Button size="lg" asChild className="peak-button-motion bg-[#2f5d3b] text-white hover:bg-[#3f744b]">
            <Link href="/signup">
              Create account
              <ArrowRightIcon />
            </Link>
